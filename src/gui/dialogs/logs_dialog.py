...
class LogsDialog(ctk.CTkToplevel):
    ...
    def create_toolbar(self):
        ...
        ctk.CTkLabel(left_frame, text=_("Period") + " :").grid(
        ...
        ctk.CTkLabel(middle_frame, text=_("Lines") + " :").grid(
            row=0, column=0, padx=(0, 5)
        )
        ...
        refresh_button = ctk.CTkButton(
            right_frame, text=_("Refresh"), command=self.update_logs, width=100
        )
        refresh_button.grid(row=0, column=0, padx=5)

        close_button = ctk.CTkButton(
            right_frame, text=_("Close"), command=self.on_close, width=100
        )
    ...
    def create_log_view(self):
        ...
        self.log_text = ctk.CTkTextbox(
            log_container, wrap="none", font=("Courier", 12), height=600
        )
